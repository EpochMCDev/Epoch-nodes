...
export const OptionsPane = (props) => {
    ...
    return (
        <>
            ...
            <div className="nodes-editor-panel-title">选项:</div>

            <div className="nodes-editor-section-header">领土费用参数:</div>
            ...
            <div className="nodes-editor-section-header">默认资源属性:</div>
            <div id="nodes-ace-editor-default-resource-container">
                {codeEditor}
            </div>

            <div className="nodes-editor-section-header">背景图片:</div>
            <div className="nodes-editor-setting-field">
                <div>URL:</div>
                <UI.InputEdit
                    className={"nodes-editor-setting-input"}
