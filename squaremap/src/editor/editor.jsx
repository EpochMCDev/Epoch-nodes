 ...
 *
 * squaremap fork: chinese ui text, tab labels, fixes towns pane id.
 */
...
const EditorTab = (props) => {
    ...
    return (
        <div className={className} onClick={props.onClick} title={props.label}>
            <img src={props.icon} className="nodes-editor-tab-icon" draggable="false"/>
            <div className="nodes-editor-tab-label">{props.label}</div>
        </div>
    );
}
...
export const Editor = (props) => {
    ...
    return (
        ...
        <div id="nodes-editor">
            ...
            <div id="nodes-header">
                <div id="nodes-header-text">节点世界编辑器</div>
                <div id="nodes-header-btns">
                    { props.uploadEnabled ?
                    <>
                    <EditorHeaderButton hint={"合并"} icon={IconMerge} onMouseDown={() => {loadFile(true)}}/>
                    <EditorHeaderButton hint={"加载"} icon={IconLoad} onMouseDown={() => {loadFile(false)}}/>
                    </>
                    : (null)
                    }
                    { props.editorEnabled ?
                    <EditorHeaderButton hint={"保存"} icon={IconSave} onMouseDown={props.save}/>
                     : (null)
                    }
                </div>
            </div>
